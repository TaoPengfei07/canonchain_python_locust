...
class UserBehavior(TaskSet):
	...
	def test_transfer_accounts(self):
		try:
			a = self.locust.user_data_queue.get()
			b = self.locust.user_data_queue.get()
		except queue.Empty:
			print('account data run out')
			return False
		...
		self.locust.user_data_queue.put_nowait(a)
		self.locust.user_data_queue.put_nowait(b)
